...
"""autogenerated by genpy from robot/invRequest.msg. Do not edit."""
import codecs
import sys
...
class invRequest(genpy.Message):
  _md5sum = "f192399f711a48924df9a394d37edd67"
  _type = "robot/invRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(invRequest, self).__init__(*args, **kwds)
...
def _get_struct_7d():
    ...
    return _struct_7d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from robot/invResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class invResponse(genpy.Message):
  _md5sum = "13b568889983e6c4080c58d8e7c2c89c"
  _type = "robot/invResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(invResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
class inv(object):
  ...
  _request_class  = invRequest
  _response_class = invResponse
