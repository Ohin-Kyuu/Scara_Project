...
class invRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type invRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type invRequest
    let len;
    let data = new invRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new invRequest(null);
...
class invResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type invResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type invResponse
    let len;
    let data = new invResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new invResponse(null);
...
module.exports = {
  ...
  md5sum() { return '8124fdf484553a52e7b685afd1f774e4'; },
  datatype() { return 'robot/inv'; }
};
