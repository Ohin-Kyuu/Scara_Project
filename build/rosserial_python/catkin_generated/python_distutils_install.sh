...
echo_and_run cd "/home/scara/scara/src/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/scara/scara/src/rosserial_python/setup.py" \
     \
    build --build-base "/home/scara/scara/build/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
