...
echo_and_run cd "/home/scara/scara/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/scara/scara/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/scara/scara/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
