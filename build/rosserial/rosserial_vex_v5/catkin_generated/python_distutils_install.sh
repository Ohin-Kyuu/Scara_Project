...
echo_and_run cd "/home/scara/scara/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/scara/scara/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/scara/scara/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
