...
echo_and_run cd "/home/scara/scara/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/scara/scara/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/scara/scara/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
